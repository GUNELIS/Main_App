...
public class Intruder implements Agent {
    ...
    public Intruder(Scenario scenario,Point location, GameFrame gameFrame, String id){
        ...
        setLocation(new Point(98* scenario.getScale(),4* scenario.getScale()));
        ...
        line2Target = new Line(location, sharedArray.getPoint(54, 51));
    ...
    public void teleports(){
        ...
        if(mapArray.getPoint(location.getX(), location.getY()).isIsteleport()){
